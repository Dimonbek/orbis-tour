# Mir Sun Travel bot — GitHub'ga push va Railway'ga deploy

Kod tayyor. `.env`, `package.json`, `locales.js`, `index.js` — hammasi Mir Sun Travel uchun sozlangan.
...
2. Repository name: **mirsuntravel**
...
```
cd "C:\Users\Lenovo\Documents\mirsuntravel"
...
git init
git add .
git commit -m "Mir Sun Travel bot - Riva botidan nusxa"
git branch -M main
git remote add origin https://github.com/Dimonbek/mirsuntravel.git
...
2. **Dimonbek/mirsuntravel** ni tanlang (kerak bo'lsa GitHub'ni ulang)
...
## 4. Tekshirish
- Botga Telegram'da `/start` yozing → "Mir Sun Travel botiga xush kelibsiz" chiqadi.
