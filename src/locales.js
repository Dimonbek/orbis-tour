...
const defaultLocales = {
  uz: {
    ...
    askHotelStars: "🏨 Necha yulduzli mehmonxona xohlaysiz?",
    askPaymentType: "💳 To'lov turini tanlang:",
    ...
    age12plus: "🧑 12+ yosh",
    // Hotel stars
    star3: "⭐️⭐️⭐️ 3 yulduzli",
    star4: "⭐️⭐️⭐️⭐️ 4 yulduzli",
    star5: "⭐️⭐️⭐️⭐️⭐️ 5 yulduzli",
    // Payment options
    payCash: "💵 Naqd",
    payInstallment: "📆 Nasiya",
    // Errors
    ...
    g_hotelStars: "🏨 Mehmonxona",
    g_paymentType: "💳 To'lov turi",
    g_date: "📅 Sana",
    g_people: "👥 Odam soni",
    g_children: "👶 Bolalar",
    g_childrenYes: "Bor",
  ...
  ru: {
    ...
    askHotelStars: "🏨 Отель какой звёздности вы хотите?",
    askPaymentType: "💳 Выберите тип оплаты:",
    ...
    age7_11: "👦 7-11 лет",
    age12plus: "🧑 12+ лет",
    star3: "⭐️⭐️⭐️ 3 звезды",
    star4: "⭐️⭐️⭐️⭐️ 4 звезды",
    star5: "⭐️⭐️⭐️⭐️⭐️ 5 звёзд",
    payCash: "💵 Наличные",
    payInstallment: "📆 Рассрочка",
